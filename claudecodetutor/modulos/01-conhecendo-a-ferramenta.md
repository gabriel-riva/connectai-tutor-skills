...
- **Voz:** "se o botão de microfone aparecer no campo de mensagem, dita o próximo pedido em vez de digitar: fala do teu jeito e revisa o texto antes de enviar."- E a observação que muda a relação com a ferramenta: "repara que você não precisou ficar olhando. Ele trabalha; você volta quando quiser. Semana que vem te mostro isso rodando sozinho em horário marcado, e até do celular."
