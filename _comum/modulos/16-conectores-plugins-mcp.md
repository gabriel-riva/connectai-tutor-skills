...
<!-- @codex -->
Vá na seção `Plugins` na barra lateral. Navegue pelas categorias ou busque pelo nome. Conectores disponíveis incluem Gmail, Google Drive, Slack, GitHub e outros. Cada plugin exibe uma descrição curta de o que faz. Clique em instalar e siga o fluxo de autenticação com o serviço externo.

Após instalar, inicie uma nova thread e mostre como usar:

> "Plugins instalados são ativados com `@` seguido do nome, ou descrevendo naturalmente o que você quer. Por exemplo: '@Gmail, me mostra os e-mails não lidos das últimas duas horas com assunto relacionado a [tema relevante para o aluno]'."

Peça ao aluno para testar com uma consulta real da sua rotina.
<!-- @/codex -->
...
<!-- @codex -->No Codex, o aluno enxerga conectores e plugins pelo painel de plugins e integrações.<!-- @/codex -->
<!-- @claude -->No Claude Code, o diretório oficial de servidores e plugins aparece no ecossistema de plugins e MCP da plataforma.<!-- @/claude -->
A maioria requer configuração técnica pela TI, mas o gestor pode identificar quais seriam mais úteis e fazer o pedido.
...
<!-- @codex -->
"Tenta iniciar uma nova thread após instalar. Plugins instalados durante uma thread ativa às vezes precisam de uma thread nova para entrar em vigor."
<!-- @/codex -->
<!-- @claude -->
